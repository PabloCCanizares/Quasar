"""StreamLab entry point — `python main.py` o `python -m apps.streamlab.main`.
...
nativo (ejecución desde apps/streamlab/).
"""
...
for candidate in (_HERE, _HERE.parent.parent):  # apps/streamlab y Quasar/
