...
def main():
    ...
    print("  - Inconsistent hashtags (# / no # / CAPS / spaces)")
    print(f"  - ~{int(NUM_POSTS * MISSING_FIELD_RATIO)} posts with missing fields")
    print(f"  - ~{int(NUM_LIKES * ORPHAN_RATIO)} orphan likes")
    print("  - Self-follows and ghost follows")
    print("  - Broken encoding (Ã¡ instead of á)")
    print("  - 100-post spam burst from one bot")
