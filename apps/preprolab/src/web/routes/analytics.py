...
# --- Bloque integration ---
if "integration" in _unlocked_blocks:
    from src.web.routes import integration as _integration
else:
...
# --- Bloque normalize ---
if "normalize" in _unlocked_blocks:
    from src.web.routes import normalize as _normalize
else:
